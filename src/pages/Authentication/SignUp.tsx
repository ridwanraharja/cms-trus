...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const data: any = await query('POST', '/api/auth/signup', formData);
  ...
  return (
    <div className="rounded-sm h-full w-full flex justify-center border overflow-y-auto border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
