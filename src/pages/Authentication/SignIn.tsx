...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const data: any = await query('POST', '/api/auth/signin', formData);
      ...
      if (data.success === true) {
        ...
        localStorage.setItem('lt', data.token);
        navigate('/');
      }
    } catch (error: any) {
  ...
  return (
    <div className="rounded-sm h-full flex justify-center items-center border overflow-y-auto border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center h-screen">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <Link className="mb-5.5 inline-block" to="/">
              <img
                className="w-[300px] bg-primary p-3 rounded-lg"
                src={Logo}
                alt="Logo"
              />
            </Link>
              ...
              <div className="mb-5">
                ...
                >
                  {loading && (
                    <svg
                      aria-hidden="true"
                      className="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-primary mr-3"
                      viewBox="0 0 100 101"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                    >
